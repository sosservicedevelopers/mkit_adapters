    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXRoadLib(routeBuilder =>
            {
                ...
                routeBuilder.MapWebService<ServiceManager>("/GetListOfCinematografy");
                routeBuilder.MapWebService<ServiceManager>("/GetListOfCinemaCert");
                routeBuilder.MapWebService<ServiceManager>("/GetListOfCinemaDocs");                
            });
